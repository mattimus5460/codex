...
contract TreeAccessControl is CodexOwner {
    ...
    //
    //     - The CFO: The CFO can withdraw funds from TreeCore and its auction contracts.
    //
    //     - The COO: The COO can release gen0 seedling to auction, and mint promo cats.
    //
...
//      tree.tertiary = _tertiary; excluded due to stack limit of 12 fields available per function
        tree.fruit = _fruit;
        tree.leaves = _leaves;
        tree.water = _water;
        tree.soil = _soil;
